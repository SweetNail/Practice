...
namespace LeetcodeApp.common
{
    ...
    public class MailHelper
    {
        ...
        public MailHelper(string from, string fromName, string recipient, string recipientName, string subject, string body, string host, int port, string username, string password, bool isBodyHtml, string filepath)
        {
            this._from = from;
        ...
        /// <param name="password">登录电子邮件服务器的用户密码</param>  
        /// <param name="isBodyHtml">邮件的正文是否是HTML格式</param>  
        public MailHelper(string from, string fromName, string recipient, string recipientName, string subject, string body, string host, int port, string username, string password, bool isBodyHtml)
        ...
        /// <param name="password">登录电子邮件服务器的用户密码</param>  
        /// <param name="isBodyHtml">邮件的正文是否是HTML格式</param>  
        public MailHelper(string from, string fromName, string recipient, string recipientName, string subject, string body, string host, string username, string password)
        ...
        /// <param name="password">登录电子邮件服务器的用户密码</param>  
        /// <param name="isBodyHtml">邮件的正文是否是HTML格式</param>  
        public MailHelper(string from, string recipient, string subject, string body, string host, string username, string password)
        ...
        /// <param name="username">登录电子邮件服务器的用户名</param>  
        /// <param name="password">登录电子邮件服务器的用户密码</param>  
        public MailHelper(string from, string recipient, string subject, string body, string host, int port, string username, string password)
