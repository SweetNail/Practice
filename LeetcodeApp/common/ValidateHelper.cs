...
namespace LeetcodeApp.common
{
    ...
    public class ValidateHelper
    {
        ...
        public static bool InIP(string sourceIP, string targetIP)
        {
            ...
            string[] sourceIPBlockList = StringHelper.SplitMulti(sourceIP, @".");
            string[] targetIPBlockList = StringHelper.SplitMulti(targetIP, @".");
        ...
        {
            string[] targetIPList = StringHelper.SplitMulti(targetIPStr, "\n");
        ...
        //{
        //    string[] periodList = StringHelper.SplitMulti(periodStr, "\n");
        ...
        {
            return IsNumericArray(StringHelper.SplitMulti(numericRuleStr, splitChar));
        }
